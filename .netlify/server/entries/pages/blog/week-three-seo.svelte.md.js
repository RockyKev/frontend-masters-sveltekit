...
const Week_three_seo_svelte = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${validate_component(Layout, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign($$props, metadata), {}, {
    default: () => {
      return `<h2 id="${"traditional-seo-strategies"}"><a href="${"#traditional-seo-strategies"}">Traditional SEO Strategies</a></h2>
...
export { Week_three_seo_svelte as default, metadata };
